<template>
  <div id="dashboard">
    <Breadcum items="[]"/>
    <LittlleCard title="Test" :item-value="256">
    ...
    <div class="flex flex-wrap -mx-3">
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 text-white">Recent Games</p>
        <div class="w-full bg-white border rounded-lg p-4">
          <div class="w-full bg-white-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
            <div>
...
import Breadcum from "@/components/Widgets/Breadcum.vue";
import LittlleCard from "@/components/Widgets/LittlleCard.vue";
